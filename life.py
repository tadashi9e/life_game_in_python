...
3. 上で得たリストに含まれる座標について、その座標が何回リスト上に出現するか個数を数えます。
...
[画面表示](https://qiita.com/tadashi9e/items/31514172144daf0f5b17)、[ファイルからの初期パターンの読み込み](https://qiita.com/tadashi9e/items/b2ff031dd17172d5bb39)については別記事で投稿します。
